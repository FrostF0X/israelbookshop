"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6655],{
...
/* harmony import */ var _pixelunion_shopify_cross_border__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6586);
/* harmony import */ var _Accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8574);
/* harmony import */ var _Forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6383);
...
class StaticFooter {
  constructor(section) {
    ...
    this.disclosures = [];
    this.Accordion = new _Accordion__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A(this.el, {
      onStart: ({ el, state }) => {
        el
          .parentNode
          .parentNode
    ...
    this.forms = new _Forms__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A(this.$el);

    if (this.countryDisclosureEls.length > 0) {
      this.countryDisclosureEls.forEach(disclosureEl => {
        this.disclosures.push(new _pixelunion_shopify_cross_border__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(disclosureEl));
      });
    }
  ...
  _bindEvents() {
    this.$el.on('click.footer', this.accordionTrigger, event => {
      ...
      this._toggleAccordion(jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.currentTarget).parent()[0]);
    });
  }
