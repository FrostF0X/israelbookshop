...
/* harmony import */ var _helpers_throttle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4704);
...
class BackToTop {
  constructor(el) {
    ...
    this.animations = {
      button: (0,_pixelunion_animations__WEBPACK_IMPORTED_MODULE_0__/* .transition */ .kY)({ el }),
      label: (0,_pixelunion_animations__WEBPACK_IMPORTED_MODULE_0__/* .transition */ .kY)({
        el: label,
        state: 'hidden',
      }),
    };
    ...
    this.events.register(window, 'scroll', (0,_helpers_throttle__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(() => this._onScroll(), 100));
  }
  ...
  _onScroll() {
    if (_pixelunion_breakpoint__WEBPACK_IMPORTED_MODULE_2__.max('S')) return;
