  ...
  _createClass(ComplementaryProducts, [{
    ...
    value: function loadRecommendations() {
      ...
      AsyncView.load(url, {
        ...
        if (!_pixelunion_rimg_shopify__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.instance) {
          _pixelunion_rimg_shopify__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.init();
        }

        _pixelunion_rimg_shopify__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.watch(_this.recommendationsEl);
