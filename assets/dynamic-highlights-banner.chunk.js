...
/* harmony import */ var flickity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2522);
...
class DynamicHighlightsBanner {
  ...
  _bindFlickity() {
    if (_pixelunion_breakpoint__WEBPACK_IMPORTED_MODULE_1__.max('M') && this.flickity === null && this.$carousel[0]) {
      this.flickity = new (flickity__WEBPACK_IMPORTED_MODULE_3___default())(this.$carousel[0], this.flickityOptions);
    }
  }
