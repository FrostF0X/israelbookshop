...
- Name: visual.spec.js >> Visual Regression Tests >> should load /policies/terms-of-service successfully and match baseline screenshot
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 9165px, received 1280px by 720px. 

  Snapshot: policies_terms-of-service.png

Call log:
  - Expect "toHaveScreenshot(policies_terms-of-service.png)" with timeout 60000ms
