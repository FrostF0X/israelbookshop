...
- Name: visual.spec.js >> Visual Regression Tests >> should load /cart successfully and match baseline screenshot
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1338px, received 1280px by 720px. 159701 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: cart.png

Call log:
  - Expect "toHaveScreenshot(cart.png)" with timeout 60000ms
