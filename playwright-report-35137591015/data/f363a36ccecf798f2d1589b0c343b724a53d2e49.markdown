...
- Name: visual.spec.js >> Visual Regression Tests >> should load /policies/shipping-policy successfully and match baseline screenshot
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1923px, received 1280px by 720px. 183113 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: policies_shipping-policy.png

Call log:
  - Expect "toHaveScreenshot(policies_shipping-policy.png)" with timeout 60000ms
