...
- Name: visual.spec.js >> Visual Regression Tests >> should load /policies/refund-policy successfully and match baseline screenshot
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 2027px, received 1280px by 720px. 184987 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: policies_refund-policy.png

Call log:
  - Expect "toHaveScreenshot(policies_refund-policy.png)" with timeout 60000ms
